    ...
    <div className="relative min-h-[calc(100vh-140px)] flex items-center justify-center bg-surface-dark py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 w-full max-w-[420px] bg-white border-2 border-surface-lighter rounded-2xl p-8 sm:p-10 shadow-[6px_6px_0px_rgba(26,29,32,0.04)]">
        ...
        <div className="mb-6 border-b border-surface-light pb-4">
          <h1 className="text-lg font-bold text-text tracking-tight">Sign In</h1>
          <p className="text-xs text-text-muted mt-1 font-medium">Access your personal library and quizzes.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Email field */}
          <div>
            <label htmlFor="signin-email" className="mb-1.5 block text-[10px] font-extrabold text-text uppercase tracking-widest">
              Email Address
            </label>
          ...
          {/* Password field */}
          <div>
            <label htmlFor="signin-password" className="mb-1.5 block text-[10px] font-extrabold text-text uppercase tracking-widest">
              Password
            </label>
            <div className="relative">
